...
export function calculateProfit() {
    ...
    const formula = ( (((( (apPercent / 100) + 1) * (usePetBonus / 100) * (perfectMultiplier + perfectMultiplierExtender) * (divinityMultiplier * divineMultiplierExtender) ) * fivePecentPerWorker) * remoteMultiplier) * doubledFoodMultiplier) * doubledMultiplier;
